   ...
   <body class="main-layout inner_page">
      ...
      <div class="container-prod">
         ...
         <% 
             ...
             List<Product> products = productDAO. getcart(email);
        ...
        <div class="product" style="height:371px; width: 241px;" >
           <a href="ShowDetail.jsp?productId=<%=id%>&name=<%=name%>&price=<%=price%>&descrip=<%=descrip%>&image=<%=image%>&bidder=<%=bidder%>&seller=<%=seller%>&ty=<%=ty%>" >
