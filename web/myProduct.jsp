...
<html lang="en">
   ...
   <body class="main-layout inner_page">
                  ...
                  <div class="row">
                     ...
                     <div class="col-md-3">
                        <ul class="contat_infoma text_align_right">
                           <li><a href="Javascript:void(0)"> <i class="fa fa-phone" aria-hidden="true"></i> auctionflow@gmail.com</a></li>
                        </ul>
                     </div>
                  </div>
               </div>
      ...
      <div class="container-prod">
          <a href="addProduct.html" class="inp-add-product-button">Add New Product</a>
         <!---------------------------- First Row ---------------------------->
       
         <div class="product-container" style="display: ruby">
    <% 
         ProductDAO productDAO = new ProductDAO();
         List<Product> products = productDAO.getsell(email);
     ...
     %>
        <div class="product" style="height:391px; width: 241px;" >
            <a href="ShowDetail.jsp?productId=<%=id%>&name=<%=name%>&price=<%=price%>&descrip=<%=descrip%>&image=<%=image%>&bidder=<%=bidder%>&seller=<%=seller%>" >
